...
PS1='${debian_chroot:+($debian_chroot)}\[\033]0;\w\007\]\[\e[35;1m\]\u\[\e[0m\]\[\e[32m\]@\h\[\e[34m\]\w $(__git_ps1 " (%s)")\[\e[33m\]\$ \[\e[0m\]'	# purple, green, blue prompt w/default black & dir title
...
all_proxy=socks://localhost:3218/
https_proxy=https://localhost:3218/
